...
namespace BethanysPiShop.Migrations
{
    ...
    [Migration("20211120165805_OrderAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BethanysPiShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("BethanysPiShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("BethanysPiShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("BethanysPiShop.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BethanysPiShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("BethanysPiShop.Models.OrderDetail", b =>
                {
                    b.HasOne("BethanysPiShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BethanysPiShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BethanysPiShop.Models.Pie", b =>
                {
                    b.HasOne("BethanysPiShop.Models.Category", "Category")
                        .WithMany("Pies")
